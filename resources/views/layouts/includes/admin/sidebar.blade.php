                ...
                @else
                    ...
                    <li>
                        ...
                        <ul id="dropdown-{{ Str::slug($link['name']) }}" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="{{ $subItem['href'] }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ $subItem['active'] ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    {{ $subItem['name'] }}
                                </a>
                            </li>
                            @endforeach
...
<!-- Incluir Flowbite para la funcionalidad del toggle -->
